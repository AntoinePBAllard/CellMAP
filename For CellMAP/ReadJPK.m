...
jlength_location = strcmp(header_metadata_split(:,1),'quantitative-imaging-map.position-pattern.grid.jlength')==1;
jlength = str2double(header_metadata_split(jlength_location,2));
